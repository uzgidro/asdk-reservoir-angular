...
export class ModsnowService {
  ...
  getCover(): Observable<ModsnowImageResponse[]> {
    return of([
      {name: 'Andijon', url: 'assets/img/1. Андижон/2025196.jpeg'},
      {name: 'Ohangaron', url: 'assets/img/2. Охангарон/2025196.jpeg'},
      {name: 'Chorvoq', url: 'assets/img/3. Чорвок/2025196.jpeg'},
      {name: 'Hisorak', url: 'assets/img/7. Хисорак/2025196.jpeg'},
      {name: 'To\'palang', url: 'assets/img/8. Туполанг/2025196.jpeg'},
    ])
  }
